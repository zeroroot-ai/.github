...
This file is the per-repo addendum. Workspace-wide concerns live in [`~/Code/zero-day.ai/CLAUDE.md`](https://github.com/zeroroot-ai/.github/blob/main/AGENTS.md); architectural decisions in [`docs/adr/`](https://github.com/zeroroot-ai/docs/tree/main/adr).
...
- Per-repo ADRs: [`docs/repos/<repo>/adr/`](https://github.com/zeroroot-ai/docs/tree/main/repos)
